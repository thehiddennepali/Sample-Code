...
echo "markersData[0] = {
    ...
    'url_point': '" . Yii::$app->urlManager->createUrl(['merchant/view', 'id' => $model->merchant_id]) . "'
    };";
    ...
    <div id="subheader">
        <div id="sub_content">
            <div id="thumb">
                ...
                <?php echo Html::img($model->behaviors['imageBehavior']->getImageUrl()) ?>
            ...
            <div class="rating">
                ...
                ?>
                (<small><a href="#0"><?php echo $queryCountRating;?> 
            ...
            <div><i class="icon_pin"></i> 
                <?php echo $model->address ?>- <i class="icon-phone-squared"></i> 
                <a href="tel:+<?php echo $model->contact_phone ?>" target="_blank">
                    <?php echo $model->contact_phone ?></a>
            </div>
            <div><i class="icon-website-circled"></i> 
                <a href="<?php echo $model->url; ?>" target="_blank"> <?php echo $model->url; ?></a></div>
        </div><!-- End sub_content -->
    </div><!-- End subheader -->
</section><!-- End section -->
<!-- End SubHeader ============================================ -->
...
<div class="container margin_60_35">
    ...
    <div class="row">
        ...
        <a href="<?php echo Yii::$app->urlManager->createUrl(['merchant/search','Merchant[search]' => $keyword])?>" class="btn_1 add_bottom_15">
...
foreach ($gallery->galleryPhotos as $photo){?>
                                     <div class="sp-slide">
        <img class="sp-image" src="<?php echo $photo->getPreview()?>" alt="">
 </div>
...
<?php //echo Html::img($model->behaviors['imageBehavior']->getImageUrl(), ['class' => 'thumb_strip1 img-responsive']) ?>
                            </div>
...
//                        exit;
        ...
        <div class="col-md-4">
            ...
            <?php echo $this->render('view_right_bar', ['model' => $model,
