                    ...
                    <h4 class="nomargin_top">
                        ...
                        <ul class="opening_list">
                            ...
                            if(!empty($queryVoucher)){
                             echo '<li><i class="icon-gift"></i> Gutscheine <span  class="label label-success"><i class="icon_check_alt2 ok"></i> </span></li>';   
                            }
                            
                            if(!empty($queryLoyality) && $queryLoyality['is_active'] == 1){
                                echo '<li><i class="icon-heart"></i> Treuepunkte <span  class="label label-success"><i class="icon_check_alt2 ok"></i> </span></li>';
                            }
                            
                            if(!empty($queryVoucher)){
                                
                                
                                echo '<li><i class="icon-euro"></i> Aktion ';
                                echo '<ul>';
...
<?php echo $form->field($appointment, 'date_time') ?>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="form-group">
                <label><?php echo Yii::t('basicfield', 'Voucher')?></label>
<?php echo $form->field($appointment, 'coupone')->textInput(['placeholder' => Yii::t('basicfield', 'Apply Voucher')]) ?>
...
<?php echo $form->field($appointment, 'apply_coupon')->checkbox(['class' => 'icheck coupon',
    ...
    'data-merchanid' => $model->id
                ...
                <?php echo Yii::t('basicfield', Yii::t('basicfield', 'Apply Voucher'))?>
                </label>
        </div>
    </div>
    <hr>					
            ...
            <tr>
                <td class="total">
                    <?php echo Yii::t('basicfield', 'TOTAL');?> <span class="pull-right">€ 
                        <span id="total"><?php echo number_format($session['total'] - $session['discount'], 2, '.', '') ?></span></span>
                </td>
            </tr>
        </tbody>
    </table>
